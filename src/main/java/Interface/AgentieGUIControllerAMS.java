 ...
 */
public class AgentieGUIControllerAMS implements Observer<Excursie> {
    @FXML
    ...
    Stage currentStage;
    public void setController(ClientControllerAMS ctrl){
        this.ctrl = ctrl;
    ...
    @FXML
    public void initialize(ClientControllerAMS ctrl,Stage primaryStage){
    ...
    private void logOutHandler(){
        try{
            ...
            loader.setLocation(AgentieGUIControllerAMS.class.getClassLoader().getResource("login.fxml"));
